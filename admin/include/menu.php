      ...
      ?>
            <li class="nav-item">
                <a class="nav-link" href="?action=xldathang">
                    ...
                    <span>Đơn Đặt Hàng <sup style="border-radius: 10px;" class="badge-danger "> &#160;<?php echo $dem ?>
                            &#160;</sup></span></a>
            </li>
            <!-- Nav Item - Charts -->
            <?php
      ...
      ?>
            <li class="nav-item">
                <a class="nav-link" href="?action=giaohang">
                    ...
                    <span>Giao Hàng <sup style="border-radius: 10px;" class="badge-danger "> &#160;<?php echo $dem ?>
                            &#160;</sup></span></a>
