<?php
    ...
    $product_detail_image_result = product_detail_image($id);
    if (!$product_detail_image_result) {
        $product_detail_image = array('Anh1' => 'loader.gif', 'Anh2' => 'loader.gif', 'Anh3' => 'loader.gif', 'Anh4' => 'loader.gif');
    } else {
        $product_detail_image = mysqli_fetch_array($product_detail_image_result);
    }
?>
<style>
.color-wrap {
...
<div class="breadcrumbs">
    <div class="container">
        <div class="row">
            <div class="col">
                <p class="bread"><span><a href="?view">Trang chủ</a></span> / <span>Chi tiết sản phẩm</span></p>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row row-pb-lg product-detail-wrap">
                    ...
                    <div class="item">
                        <div class="product-entry border">
                            <a href="#" class="prod-img">
                                <img src="webroot/image/sanpham/<?php echo $product_detail_image['Anh1'] ?>" class="img-fluid" alt="Truong Uy Code">
                            </a>
                        </div>
                    </div>
                    <div class="item">
                        <div class="product-entry border">
                            <a href="#" class="prod-img">
                                <img src="webroot/image/sanpham/<?php echo $product_detail_image['Anh2'] ?>" class="img-fluid" alt="Truong Uy Code">
                            </a>
                        </div>
                    </div>
                    <div class="item">
                        <div class="product-entry border">
                            <a href="#" class="prod-img">
                                <img src="webroot/image/sanpham/<?php echo $product_detail_image['Anh3'] ?>" class="img-fluid" alt="Truong Uy Code">
                            </a>
                        </div>
                    </div>
                    <div class="item">
                        <div class="product-entry border">
                            <a href="#" class="prod-img">
                                <img src="webroot/image/sanpham/<?php echo $product_detail_image['Anh4'] ?>" class="img-fluid" alt="Truong Uy Code">
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <form class="col-sm-4" action="?view=addtocart" method="post" id="form1">
                ...
                <div class="col-sm-12 text-center">
                    <p class="addtocart"><button type="submit" form="form1" name='addtocart' class="btn col-sm-12 btn-primary" onclick="return validateForm()">
                        Thêm vào giỏ hàng
                    </button></p>
                </div>
            </form>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    sizeRadios.forEach(function(radio) {
        radio.addEventListener('click', function() {
            ...
            var quantityInfo = document.querySelector('.quantity-info[data-size="' + selectedSize + '"]');

            if (quantityInfo) {
                quantityInfoLabel.innerText = 'Size: ' + selectedSize + ', Số lượng: ' + quantityInfo.innerText;
            }
        });
    });
});
